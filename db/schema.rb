...
ActiveRecord::Schema.define(version: 2019_09_09_114253) do
  ...
  create_table "sysadmins", force: :cascade do |t|
    ...
    t.index ["email"], name: "index_sysadmins_on_email", unique: true
    t.index ["reset_password_token"], name: "index_sysadmins_on_reset_password_token", unique: true
  end
